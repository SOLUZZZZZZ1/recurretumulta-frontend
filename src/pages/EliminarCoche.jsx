  ...
  if (paidOk) {
    return (
      <main style={{ padding: "42px 18px" }}>
        ...
        >
          <h1 style={{ margin: "0 0 14px", fontSize: 32 }}>
            ✅ Pago realizado correctamente
          </h1>

          <p style={{ fontSize: 18, lineHeight: 1.7, margin: 0 }}>
            Hemos recibido tu solicitud para gestionar la baja/retirada del vehículo.
          </p>

          <p style={{ fontSize: 17, lineHeight: 1.7, marginTop: 14 }}>
            Te enviaremos la confirmación y los próximos pasos por email.
          </p>
          ...
          >
            ...
            <ul style={{ marginBottom: 0, paddingLeft: 20 }}>
              <li>Revisaremos la documentación recibida.</li>
              <li>Contactaremos contigo si falta algún dato.</li>
              <li>Iniciaremos la gestión con el centro autorizado cuando proceda.</li>
            </ul>
          </div>
        </section>
      </main>
